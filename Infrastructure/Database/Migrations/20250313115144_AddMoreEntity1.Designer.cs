...
namespace Infrastructure.Database.Migrations
{
    ...
    [Migration("20250313115144_AddMoreEntity1")]
    partial class AddMoreEntity1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.DocumentSharing.ShareRequest.ShareRequests", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("RequestScope")
                        .HasColumnType("integer")
                        .HasColumnName("request_scope");

                    b.Property<int>("RequestShareType")
                        .HasColumnType("integer")
                        .HasColumnName("request_share_type");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_share_requests");

                    b.HasIndex("Requester")
                        .HasDatabaseName("ix_share_requests_requester");
            ...
            modelBuilder.Entity("Domain.UserManagements.User.Users", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Domain.DocumentSharing.ShareRequest.ShareRequests", b =>
                {
                    b.HasOne("Domain.UserManagements.User.Users", null)
                        .WithMany()
                        .HasForeignKey("Requester")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_share_requests_users_requester");
                });
